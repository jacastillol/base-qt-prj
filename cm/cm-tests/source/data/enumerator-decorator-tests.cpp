...
void
EnumeratorDecoratorTests::setValue_givenNewValue_updatesValueAndEmitsSignal()
{
    Entity parentEntity;
    EnumeratorDecorator decorator(
                &parentEntity,
...
void EnumeratorDecoratorTests::jsonValue_whenDefaultValue_returnsJson()
{
    ...
    QCOMPARE(decorator.jsonValue(),
             QJsonValue(static_cast<int>(eTestEnum::Unknown)));
}
...
void EnumeratorDecoratorTests::jsonValue_whenValueSet_returnsJson()
{
    ...
    QCOMPARE(decorator.jsonValue(),
             QJsonValue(static_cast<int>(eTestEnum::Value2)));
}
...
void
EnumeratorDecoratorTests::update_whenNotPresentInJson_updatesValueToDefault()
{
    Entity parentEntity;
    EnumeratorDecorator decorator(
                &parentEntity,
